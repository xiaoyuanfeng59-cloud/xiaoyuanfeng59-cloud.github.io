...
export const themeTokens = [
  ...
  { key: "bgGlow", label: "顶部氛围", value: "#999999" },
  { key: "panel", label: "卡片背景", value: "#ffffff" },
  { key: "surface", label: "按钮/事件", value: "#ffefed" },
  { key: "surfaceAlt", label: "输入/评分底", value: "#ffffff" },
  { key: "surfaceSoft", label: "次级按钮", value: "#ebebeb" },
  { key: "surfaceBlue", label: "灰蓝按钮", value: "#eeebeb" },
  { key: "accent", label: "主强调", value: "#474747" },
  { key: "accentStrong", label: "选中按钮", value: "#5c5c5c" },
  { key: "accentText", label: "强调文字", value: "#474747" },
  { key: "activeText", label: "导航激活", value: "#cf8c94" },
  { key: "blue", label: "灰蓝辅助", value: "#a7c6ff" },
  { key: "blueText", label: "灰蓝文字", value: "#9eb0bd" },
  { key: "success", label: "完成态", value: "#dfeed4" },
  { key: "successText", label: "完成文字", value: "#76bb40" },
  { key: "text", label: "主文字", value: "#474747" },
  { key: "muted", label: "次级文字", value: "#5c5c5c" },
  { key: "border", label: "边框", value: "#707070" },
  { key: "danger", label: "危险按钮", value: "#ff6250" },
] as const;
